            ...
            <div class="fixed inset-0 overflow-hidden">
                <div class="absolute inset-0 overflow-hidden">
                    <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                        <div v-if="route.query.section === 'cart-list'" class="pointer-events-auto w-screen max-w-md">
                                                    ...
                                                    <div class="ml-4 flex flex-1 flex-col">
                                                        <div>
                                                            <div
                                                                ...
                                                                <p class="ml-4">{{ formatToNaira(item.price *
            item.count) ||
            'Nil' }}</p>
                                                            </div>
                                            ...
                                            <div v-else
                                                ...
                                                <p class="text-sm font-light text-gray-500">Your cart is currently empty
                                                </p>
                        ...
                        <div v-if="route.query.section === 'payment-methods'" class="w-full pt-6">
