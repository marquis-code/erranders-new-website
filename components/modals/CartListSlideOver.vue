                    ...
                    <div class="pointer-events-auto w-screen max-w-md">
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                ...
                                <div class="mt-8">
                                    <div class="flow-root">
                                        <ul v-if="cartList.length" role="list" class="-my-6 divide-y divide-gray-200">
                                                ...
                                                <div class="ml-4 flex flex-1 flex-col">
                                                    <div>
                                                        <div
                                                            ...
                                                            <p class="ml-4">{{ formatToNaira(item.price * item.count) ||
        'Nil' }}</p>
                                                        </div>
                                        ...
                                        <div v-else class="flex justify-center items-center flex-col pt-20 space-y-4">
                                            <img src="@/assets/img/emptycart4.png" class="h-44 w-44" alt="" />
                                            <p class="text-lg font-semibold text-gray-800">Nothing is here</p>
                                            <p class="text-sm font-light text-gray-500">Your cart is currently empty</p>
                                            <button @click="closeCart"
                                                class="bg-green-500 text-white px-6 py-2 rounded-full text-sm">Continue
                                                shopping</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div v-if="cartList.length" class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                ...
                                <div class="mt-6 w-full">
                                    <button @click="payNow" type="button"
                                        class="flex items-center w-full justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Checkout</button>
                                </div>
