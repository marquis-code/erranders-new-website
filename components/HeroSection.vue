<template>
    <div class="bg-white">
        <div class="relative isolate pt-14">
            <img src="/heroBg.svg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover bg-[#034091]">
            ...
            <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                    <div class="flex">
                        <div data-aos="flip-left"
                            class="relative bg-[#DAF7E8] flex items-center gap-x-4 rounded-full px-4 py-2 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                            <span class="font-light text-[#011633]">Your on demand solution for hassle-free
                                shopping!</span>
                        </div>
                    </div>
                ...
                <div data-aos="flip-left" class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
                    <img src="@/assets/img/errander.png" alt="" />
