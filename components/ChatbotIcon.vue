...
const redirectToWhatsApp = () => {
    const phoneNumber = '+2348147626503'; // Replace with your WhatsApp business phone number
    const message = encodeURIComponent("Hello! I'd like to know more about Erranders.");
